...
import me.changwook.service.impl.ImageMimeTypeFixService;
...
public class AdminMaintenanceController {
    ...
    public ResponseEntity<ApiResponseDTO<String>> fixImageMimeTypes() {
    ...
    public ResponseEntity<ApiResponseDTO<String>> fixImageMimeType(@PathVariable Long imageId) {
