...
public class AdminRentCarController {
    ...
    public ResponseEntity<ApiResponse<RentCarsDTO>> registerCar(@Validated @RequestBody RentCarsDTO rentCarsDTO) {
        // 임시로 기존 메서드 사용
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<Page<RentCarsDTO>>> getAllCars(Pageable pageable) {
        // 차량 목록 조회
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<RentCarsDTO>> getCarById(@PathVariable Long carId) {
        // 차량 조회
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<RentCarsDTO>> updateCar(
