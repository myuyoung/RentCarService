...
import me.changwook.image.ImageRepository;
...
public class ImageTestController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> testStreamingConfig() {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> testStreamingUrl(@PathVariable Long imageId) {
